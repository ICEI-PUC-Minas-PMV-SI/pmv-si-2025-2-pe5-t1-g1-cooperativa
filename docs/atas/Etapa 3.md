...
- **Laura** → Nesta etapa, fiz o monitoramento do serviço DHCP utilizando o Zabbix e implementei o Zabbix Agent a uma máquina Linux Ubuntu Server configurada como servidor DHCP.
