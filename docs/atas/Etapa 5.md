...
- **Luana** → Neste projeto ajudei a criar a Cred Vale Doce, sempre participando das reuniões de planejamento, dando insights sobre cores, design, missão, história, escolha das cidades, valores, estrutura administrativa, modelo teórico e ajudei na documentação e construção do protótipo no Packet Tracer. Ajudei na especificação dos requisitos e das restrições do projeto, e ajudei no preenchimento e validação da planilha de ativos da infraestrutura. Já na segunda etapa fiz o servidor e cliente AD e a documentação do mesmo, ajudei a Laura no servidor DHCP e editei o vídeo da entrega
Na etapa 3, fiquei responsável pelos servers locais do projeto. Fiz a instalação do Zabbix Appliance e o monitoramento do Server o AD e ajudei no DHCP juntando-o também com a minha máquina e preenchi a documentação do AD. Na 4ª etapa, revisei a PSI, ajudei no texto das vulnerabilidades e na confecção do texto da cartilha de segurança, fiz o evento e a cartilha da Hunting Week e fiz o resumo do trabalho. Fiz também a documentação da PSI, cartilha e evento.
Na 5ª e última etapa, fiquei responsável pela conclusão, ajudei na confecção e revisão do roteiro inicial e depois da divisão foquei em aperfeiçoar a parte de segurança da apresentação. Fiz um rascunho dos slides e depois ajudei na confecção da versão final do mesmo e participei ativamente dos ensaios, cronometrei as apresentações e dei sugestões nas versões dos outros integrantes do grupo durante os mesmos.
